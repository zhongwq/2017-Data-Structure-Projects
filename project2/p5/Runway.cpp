...
bool Runway::landingQueue_empty() const {
    return landing.empty();
}

bool Runway::landingQueue_full() const {
    return landing.isFull();
}

bool Runway::takingoffQueue_empty() const {
    return takeoffing.empty();
}

bool Runway::takingoffQueue_full() const {
    return takeoffing.isFull();
}
